  ...
  return (
    <View style={{flex:1,backgroundColor:'white',padding:20}}>
      ...
      <View style={{marginTop:20}}>
          <Text style={{color:'rgba(0,0,0,0.3)',fontSize:16,fontFamily:'Black'}}>hospital id</Text>
          <Text style={{color:'rgba(0,0,0,0.7)',fontSize:20,fontFamily:'Thin'}}>lkg098</Text>
      </View>


      <View style={{marginTop:10}}>
          <Text style={{color:'rgba(0,0,0,0.3)',fontSize:16,fontFamily:'Black'}}>hospital ph num 1</Text>
          <Text style={{color:'rgba(0,0,0,0.7)',fontSize:20,fontFamily:'Thin'}}>8988977767</Text>
      </View>


      <View style={{marginTop:10}}>
          <Text style={{color:'rgba(0,0,0,0.3)',fontSize:16,fontFamily:'Black'}}>hospital ph num 2</Text>
