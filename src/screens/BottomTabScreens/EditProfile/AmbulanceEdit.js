...
export default function AmbulanceEdit({navigation}) {
  return (
    <View style={{ flex: 1, backgroundColor: 'white', padding: 20 }}>
      ...
      <View>
        ...
        <View>
          <Text style={{ fontFamily: 'Medium', marginTop: 15 }}>
            Phone number
          </Text>
          <TextInput
        ...
        <View>
          <Text style={{ fontFamily: 'Medium', marginTop: 20 }}>
            Emergeny Contacts
          </Text>
          <TextInput
